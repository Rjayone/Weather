...
//
//  Modified by Andrew Medvedev on 06/4/15
//
...
- (void) callMethod:(NSString *) method withCallback:( void (^)( NSError* error, NSDictionary *result ) )callback
{
    ...
    NSBlockOperation* blockOperation = [NSBlockOperation blockOperationWithBlock:^(void){
        ...
        NSDictionary* JSONSerialization = [NSJSONSerialization JSONObjectWithData:json options:NSJSONReadingAllowFragments error:&localerror];
